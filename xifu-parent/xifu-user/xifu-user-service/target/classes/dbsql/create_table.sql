...
CREATE TABLE `tb_user` (
  ...
  `name` varchar(64) NOT NULL COMMENT '登录名，登录名称唯一',
...
-- 新增用户信息
INSERT INTO `tb_user` (`id`, `name`, `password`, `salt`, `nice_name`, `gender`, `phone`, `status`, `user_type`, `enterprise_id`, `email`, `qq`, `create_user_id`, `create_date`, `modify_user_id`, `modify_date`) VALUES ('1', 'admin', '62b88757bf1fd2151a63638c3895fa0f', 'interest', '系统管理员', '0', NULL, '0', '2', NULL, NULL, NULL, NULL, '2019-01-15 10:22:21', NULL, NULL);
